...
class StreamFlowPlayer {
    ...
    /**
     * Checks server status and updates UI
     */
    ...
    updateServerStatus(isOnline) {
        ...
        this.streamStatusEl.textContent = isOnline
            ? 'Server Online'
            : 'Server Offline';

        this.streamStatusEl.className = isOnline
            ? 'server-status online'
            : 'server-status offline';

        this.streamStatusEl.style.color = isOnline
            ? '#00ff00'
            : '#ff0000';
    }
